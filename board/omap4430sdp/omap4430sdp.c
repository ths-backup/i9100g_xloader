...
#define MUX_DEFAULT_OMAP4() \
	...
	MV(CP(GPMC_AD11) , ( PTD | OFF_EN | OFF_PD | OFF_OUT_PTD | M3))  /* gpio_35 */ \
	...
	MV(CP(HDMI_HPD) , (PTD | EN | M7))  /* hdmi_hpd */ \
	MV(CP(HDMI_CEC) , (PTD | EN | M7))  /* hdmi_cec */ \
	MV(CP(HDMI_DDC_SCL) , ( PTD | EN | M7))  /* hdmi_ddc_scl */ \
	MV(CP(HDMI_DDC_SDA) , ( PTD | EN | M7))  /* hdmi_ddc_sda */ \
	...
	MV(CP(I2C3_SCL) , (PTD |IEN | EN | M3))  /* i2c3_scl */ \
	MV(CP(I2C3_SDA) , (PTD |IEN | EN | M3))  /* i2c3_sda */ \
	MV(CP(I2C4_SCL) , ( PTU | IEN | M0))  /* i2c4_scl */ \
	MV(CP(I2C4_SDA) , ( PTU | IEN | M0))  /* i2c4_sda */ \
	MV(CP(MCSPI1_CLK) , ( M3))  /* gpio 134 */ \
	MV(CP(MCSPI1_SOMI) , ( M3))  /* gpio 135 */ \
	MV(CP(MCSPI1_SIMO) , ( M3))  /* gpio 136 */ \
	MV(CP(MCSPI1_CS0) , ( M3))  /* gpio 137*/ \
	...
	MV(CP(UART3_RX_IRRX) , (PTD |IEN | EN | M3))  /* uart3_rx */ \
	MV(CP(UART3_TX_IRTX) , (PTD |IEN | EN | M3))  /* uart3_tx */ \
	...
	MV(CP(MCSPI4_SOMI) , ( PTD | IEN | EN | M3))  /* gpio_153 */ \
	...
	MV(CP(UNIPRO_TY1) , ( PTD | IEN | EN | M3))  /* gpio_174 */ \
	...
	MV(CP(GPMC_AD8) , ( IEN | M3))  /* 3_TOUCH_INT gpio_32 */ \
	MV(CP(GPMC_A22) , (M7_SAFE))  /* TOUCH_nINT gpio_46 */ \
	MV(CP(GPMC_NCS4) , (M7_SAFE)) /* 3_TOUCH_EN gpio_101 */ \
	MV(CP(GPMC_NCS5) , (M7_SAFE)) /* 3_TOUCH_LED_ON gpio_102 */ \
	MV(CP(GPMC_NWP) , ( PTD | M3))  /* TOUCH_EN  gpio_54 */ \
	MV(CP(I2C3_SCL) , ( M7_SAFE))  /* i2c3_scl */ \
	MV(CP(I2C3_SDA) , ( M7_SAFE))  /* i2c3_sda */
...
void set_muxconf_regs(void)
{
	...
	/* Fix for Rev0.5 LCD DIM and UART hang issue - enable DPLL_DRIFTGUARD_EN */
	sr32(CM_CLKMODE_DPLL_PER, 8, 1, 1);
	sr32(CM_CLKMODE_DPLL_CORE, 8, 1, 1);
	sr32(CM_CLKMODE_DPLL_MPU, 8, 1, 1);
	sr32(CM_CLKMODE_DPLL_IVA, 8, 1, 1);
